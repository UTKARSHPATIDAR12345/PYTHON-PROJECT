...
class customer:
    ...
    def database_customer(self):
        ...
        if cursor_customer.fetchone():
            ...
            cursor_customer.execute('''INSERT INTO customer(customer_name, customer_number, customer_gst_number, customer_address) VALUES(?, ?, ?, ?)''',
                               (self.customer_name, self.customer_number,self.gstno,self.address))
